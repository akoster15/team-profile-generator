...
class TStylesMerger {
  ...
  buildStyles(inlineStyle, parentStyles, descriptor) {
    var _this$tagsStyles, _this$idsStyles, _model$mixedUAStyles;
    ...
    const derivedPropsFromAttributes = this.enableUserAgentStyles ? (model === null || model === void 0 ? void 0 : model.getUADerivedCSSProcessedPropsFromAttributes(descriptor.attributes, descriptor.markers)) || null : null;
    ...
    const mergedOwnProps = emptyProcessedPropsReg.merge(userAgentTagProps && this.processor.compileStyleDeclaration(userAgentTagProps), derivedPropsFromAttributes && this.processor.compileStyleDeclaration(derivedPropsFromAttributes), userTagOwnProps, ...userClassesOwnPropsList, userIdOwnProps, ownInlinePropsReg);
