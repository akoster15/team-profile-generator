...
function useAnchorOnLinkPress(tnode, onPress) {
  ...
  const shouldHandleLinkPress = tnode.tagName === 'a' && typeof normalizedHref === 'string' && typeof onPress === 'function';
...
const ARenderer = props => {
  return /*#__PURE__*/_react.default.createElement(_AElement.default, useAElementProps(props));
};
