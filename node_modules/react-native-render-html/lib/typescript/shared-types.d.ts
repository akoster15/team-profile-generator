...
import type { CSSPropertyNameList, CustomElementModel, Document, DocumentContext as TREDocumentContext, DomVisitorCallbacks, Element, HTMLContentModel, HTMLElementModel, MixedStyleDeclaration, MixedStyleRecord, NativeBlockStyles, NativeTextStyles, Node, NodeWithChildren, SetMarkersForTNode, TDocument, TNode, TPhrasing, TRenderEngineOptions, TText } from '@native-html/transient-render-engine';
