 ...
 * @public
 */
export declare function useSharedProps(): Required<RenderHTMLSharedProps>;
/**
 * @internal
 */
 ...
 * @internal
 */
export default function SharedPropsProvider(props: PropsWithChildren<RenderHTMLSharedProps>): React.FunctionComponentElement<React.ProviderProps<Required<RenderHTMLSharedProps>>>;
